...
const categories = [
  ...
  { id: 'health', label: { zh: '医疗健康', en: 'Healthcare' } },
  { id: 'ecommerce', label: { zh: '电商/生活', en: 'E-commerce' } },
  { id: 'corporate', label: { zh: '企业官网', en: 'Corporate' } },
  { id: 'ai', label: { zh: 'AI应用', en: 'AI Apps' } },
]
...
export default function WorksPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      <h1 className="text-3xl font-semibold tracking-tight text-[#171717] mb-8">
        {lang === 'zh' ? '全部作品' : 'All Projects'}
      </h1>
